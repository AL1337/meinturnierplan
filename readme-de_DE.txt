...
Tags: turnier, sport, tabelle, spiele, rangliste
Requires at least: 6.3
Tested up to: 6.9
Requires PHP: 7.4
Stable tag: 1.0.1
License: GPLv2 oder später
...
2. **Admin-Konfiguration (Nur Admin-Bereich):**
   ...
   - **Was abgerufen wird:**
     * Turniergruppen-/Abteilungsstruktur
     * Teamlisten und Namen
     * Turnieroptionen (showCourts, showGroups, showReferees, finalMatches)
   - **Zweck:**
...
* **Responsive Design** - Mobile-First-Ansatz mit CSS-Breakpoints
